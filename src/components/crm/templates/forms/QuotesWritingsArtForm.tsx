...
type QuotesWritingsArtFormProps = {
  templateData: TemplateData;
  onSubmit: (formData: FormData) => Promise<void>;
  isSubmitting: boolean;
};

export default function QuotesWritingsArtForm({ 
  templateData, 
  onSubmit, 
  isSubmitting 
}: QuotesWritingsArtFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append("template_type", "quotes_writings_art");
