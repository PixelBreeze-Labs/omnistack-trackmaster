...
type QuotesWritingsMorningFormProps = {
  templateData: TemplateData;
  onSubmit: (formData: FormData) => Promise<void>;
  isSubmitting: boolean;
};

export default function QuotesWritingsMorningForm({ 
  templateData, 
  onSubmit, 
  isSubmitting 
}: QuotesWritingsMorningFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append("template_type", "quotes_writings_morning");
