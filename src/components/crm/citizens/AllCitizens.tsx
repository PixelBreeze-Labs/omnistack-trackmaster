// components/crm/citizens/AllCitizens.tsx
"use client";
...
export function AllCitizens() {
  ...
  }, [fetchCitizens, page, pageSize, searchTerm, sortBy, sortOrder, isInitialized]);
  ...
  return (
    <div className="space-y-6 mb-8">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">All Citizens</h2>
          <p className="text-sm text-muted-foreground mt-2">
            Manage users registered through your citizen portal
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="mb-0">
            <h3 className="font-medium">Search Citizens</h3>
            <p className="text-sm text-muted-foreground">
              Search through all registered citizens
            </p>
          </div>
        </CardHeader>
                  ...
                  <TableCell colSpan={5} className="text-center py-8">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-sm text-muted-foreground max-w-sm text-center">
                        {searchTerm
                          ? "No citizens match your search criteria. Try adjusting your filters."
                          : "There are no citizens registered in the portal yet."}
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-mono">
                          {citizen.external_ids?.nextJsUserId?.substring(0, 8)}...
                        </span>
                      </div>
                    </TableCell>
                    <TableCell>
          ...
          <div className="border-t px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              ...
              <p className="text-sm text-muted-foreground min-w-[180px] text-right">
                ...
                <span className="font-medium">{totalItems}</span> citizens
              </p>
            </div>
          </div>
        </CardContent>
