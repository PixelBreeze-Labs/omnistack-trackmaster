    ...
    <form onSubmit={handleSubmit} className="card-text h-full space-y-4 text-center">
      ...
      <div className="input-area">
        ...
        <input 
          ...
          name="artical_url" 
          type="text" 
          className={`form-control w-full px-3 py-2 border ${errors.image ? 'border-red-500' : 'border-slate-300'} rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 ${selectedFile ? '' : ''}`}
